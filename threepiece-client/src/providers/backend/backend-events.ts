...
import { vrfChanceEventRequestEvent, vrfChanceEventResultEvent, vrfRngResultEvent } from "../../thirdweb/generated-contracts/vrf";
...
const unwatch = watchContractEvents({
    onEvents(events) {
        ...
        if (message) // no message for some events
